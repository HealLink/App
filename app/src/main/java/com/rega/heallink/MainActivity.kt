...
import com.rega.heallink.databinding.ActivityMainBinding
import com.rega.heallink.notification.AlarmReceiver
...
class MainActivity : AppCompatActivity(), TimePickerFragment.DialogTimeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(com.rega.heallink.R.id.nav_host_fragment_activity_main)
